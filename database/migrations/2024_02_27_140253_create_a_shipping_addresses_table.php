...
class CreateAShippingAddressesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('a_shipping_addresses', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('a_shipping_addresses');
    }
}
